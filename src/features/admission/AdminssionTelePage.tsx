      ...
      <div className="flex justify-between items-center border-b-2 border-border-primary">
        <div className="flex gap-2 items-center p-2">
          <h2 className="text-2xl font-bold text-secondary">
            Quản lý bài viết tuyển sinh điện tử viễn thông
          </h2>
        </div>
        <Button
          variant="secondary"
        ...
        >
          Thêm bài viết về tuyển sinh điện tử viễn thông
        </Button>
      </div>
      <div className="mt-4">
        <ListPost
          categoryId={ADMISSION_IDS.ADMISSION_CATEGORY}
          subCategoryId={ADMISSION_IDS.ADMISSION_TELECOMMUNICATION}
        />
      </div>
...
export default AdminssionTelePage;
