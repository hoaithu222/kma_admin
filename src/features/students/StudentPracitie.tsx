      ...
      <div className="flex justify-between items-center border-b-2 border-border-primary">
        <div className="flex gap-2 items-center p-2">
          <h2 className="text-2xl font-bold text-secondary">
            Quản lý bài viết đồ án thực hành
          </h2>
        </div>
        <Button
          variant="secondary"
        ...
        >
          Thêm bài viết về đồ án thực hành
        </Button>
      </div>
      <div className="mt-4">
        <ListPost
          categoryId={STUDENT_IDS.STUDENT_CATEGORY}
          subCategoryId={STUDENT_IDS.STUDENT_PRACTICE}
        />
      </div>
...
export default StudentPracitie;
